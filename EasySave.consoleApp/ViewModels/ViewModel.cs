...
namespace EasySave.consoleApp.ViewModels
{
    public class ViewModel
    {
        ...
        {
            return _InputProcessingService.OptionSelectedTreatment(UserChoice);
        }

        public int ConfirmationTreatment(string UserKey)
        {
            return _InputProcessingService.ConfirmationTreatment(UserKey);
        }

        public int CheckSaveWorkIDTreatment(string UserSaveWorkID)
        {
            return _InputProcessingService.CheckSaveWorkIDTreatment(UserSaveWorkID, _Model.ArrayOfSaveWork.Count);
        }
        ...
        {
            return _SaveWorkManager.RemoveSaveWork(SaveWorkID, _Model.ArrayOfSaveWork);
        }
